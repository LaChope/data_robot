...
layout = html.Div([
    ...
    html.Div(
        [
            dt.DataTable(
                id='Table-JLR',
                columns=[{"name": i, "id": i} for i in df_JLR.columns],
                data=df_JLR.to_dict('records'),
                sort_action='native',
...
@app.callback(
    Output('datatable-subplots-JLR', 'figure'), 
    [Input('CW-RangeSlider-JLR', 'value')
    ])
